...
const { SIGNIN, SIGNUP, WISHLIST, CATEGORIES, CHECKOUT, PAYMENT, PAYMENT_COMPLETE } = ROUTES;
...
const OrderPayment = lazy(() => import("../features/user/components//payment/OrderPayment"));
    ...
    <Suspense fallback={<Loader />}>
      <Routes>
        ...
        <Route element={<Protected auth={authUser} />}>
          ...
          <Route exact path={PAYMENT_COMPLETE} element={<PaymentConfirm />} />
        </Route>
